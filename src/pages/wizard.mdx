...
* If the user enters an email address that matches an existing account, we
  gently redirect them to the login page.

<Canvas of={WizardStories.ExistingEmail} sourceState="hidden" />
